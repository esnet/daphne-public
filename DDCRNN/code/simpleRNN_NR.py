...
folder = 'Results/Results_SimpleRNN_NR'
if not os.path.exists(folder):
    os.makedirs(folder)   
df_mae.to_csv(folder + '/MAE_SimpleRNN.csv')    
df_rmse.to_csv(folder + '/RMSE_SimpleRNN.csv')   
df_mse.to_csv(folder + '/MSE_SimpleRNN.csv')  
df_r2.to_csv(folder + '/R2_SimpleRNN.csv') 
df_mape.to_csv(folder + '/MAPE_SimpleRNN.csv')    
