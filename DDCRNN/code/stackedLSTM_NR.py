...
folder = 'Results/Results_stackedLSTM_NR'
if not os.path.exists(folder):
    os.makedirs(folder)   
df_mae.to_csv(folder + '/MAE_stackedLSTM.csv')    
df_rmse.to_csv(folder + '/RMSE_stackedLSTM.csv')   
df_mse.to_csv(folder + '/MSE_stackedLSTM.csv')  
df_r2.to_csv(folder + '/R2_stackedLSTM.csv') 
df_mape.to_csv(folder + '/MAPE_stackedLSTM.csv')    
