...
from gym_deeproute.envs.mininet_backend import MininetBackEnd


path = 'config.yaml'  # always use slash in packages
filepath = pkg_resources.resource_filename('gym_deeproute', path)
config = cfg_load.load(filepath)
logging.config.dictConfig(config['LOGGING'])


class DeeprouteEnv(gym.Env):
    """
	...
	self.LINK_SELECT_ACTION_LBNL = 2
        ...
        # Choose link1 or Link2 or Link3 or Link4
